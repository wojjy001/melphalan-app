...
$INPUT NOTE ID TIME DV level AMT RATE MDV DVID CMT WT CRCL FFM HCT GCSF SLC7A5 BUN ANCBASE SEX WBC LNP53FOLD
$DATA ..\SEX_5dose_SIM_Female_JW.csv IGNORE=#
...
$TABLE SET level ID TIME AMT MDV DVID CMT Y IPRED
