...
$DES
	...
	IF(ANC_4.LT.0.5) THEN
		G4N_EXIT = T	;Find the time when ANC exits Grade 4 Neutropenia
	ENDIF
	
	DADT(9) = 0
	IF(ANC_4.LT.0.5) DADT(9) = 1

$ERROR 
	G4ND = A(9)	;Calculate the duration in Grade 4 Neutropenia
...
$SIMULATION (632541) ONLYSIM SUBPROBLEMS = 1
