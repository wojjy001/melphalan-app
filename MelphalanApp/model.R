...
$MAIN	//////////////////////
	...
	// Individual PK parameter values
	if (ID == 1) {
	 BSVCL = 0; // For the population typical individual
	 BSVV1 = 0;
	 BSVQ = 0;
	}
	...
	// Individual PD parameter values
	if (ID == 1) {
	 BSVBASE = 0; // For the population typical individual
	 BSVSLOPE = 0;
	 BSVMTT = 0;
	 BSVIP0 = 0;
	}
